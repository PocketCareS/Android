...
4. The application is already configured with the IBM server URL. If you want to run server on your local machine follow the [server setup documentation](https://github.com/PocketCareS/server/blob/master/Installation.md) and replace the [**serverHost**](https://github.com/PocketCareS/PocketCareS-Android/blob/master/app/src/main/java/com/ub/pocketcares/network/ServerHelper.java#L46) variable in with your URL. 
```java
